...
- Planen må fortsatt gå opp, og det er ditt ansvar å sjekke: 20 padler (11 erfarne, 9 rookies: 5 på run 1, 4 på run 2); 17 kajakker med (11 erfarne har hver sin, rookiene deler på 5, den 17. er reserve på Kruke); kajakkplass henger 10, Wiktor 4, Caroline 2, akkurat 16; før hvert run settes Wiktors og Carolines bil på take out Playrun så begge kjører hjem derfra, og 9-seteren tar rookiene fra take out Bru-bru via Kruke til put inn før den henter de erfarne på take out Playrun; hvert kjørelegg kan ha `alt` med andre som like godt kan kjøre, og `parked: true` betyr at bilen står; seter 9-seteren 9, Wiktor 5, Helene 4, Caroline 3, og Helenes bil står på Kruke hele dagen; førerkort som i src/lib/participants.ts (automat kan bare kjøre Carolines bil; ingen uten oppgitt lapp kjører); 9-seteren med henger kjøres bare av noen med manuell lapp; hvert run må ha nok sjåfører til å få alle biler og kajakker dit de skal; ingen skal kjøre noe de har sagt de ikke vil kjøre; ingen rookie padler to runs uten å ha bedt om det. Går det ikke opp, gjør det som går opp og forklar resten i kommentaren, eller avvis.
