...
- Planen må fortsatt gå opp, og det er ditt ansvar å sjekke: 20 padler (11 erfarne, 9 rookies: 5 på run 1, 4 på run 2); 17 kajakker med (11 erfarne har hver sin, rookiene deler på 5, den 17. er reserve); kajakkplass henger 10, Wiktor 2 (kan ta 4 om det må), Tiril 4 (takstativ), Caroline 2, altså 18; om morgenen går 10 på hengeren, 3 på Tirils bil, 2 på Wiktors og 2 på Carolines; Tiril dro hjem, men bilen hennes er med (automat, Helene og Ludvig kjører den, Maja kan også); før hvert run settes Wiktors og Carolines bil på take out Playrun så begge kjører hjem derfra, og Tirils bil på take out Bru-bru så den tar rookiene videre med 4 kajakker, den femte går på hengeren; `shortPlan` øverst på /runs er kortversjonen som leses ved frokosten, hold den i takt med resten; hvert kjørelegg kan ha `alt` med andre som like godt kan kjøre, og `parked: true` betyr at bilen står; seter 9-seteren 9, Wiktor 5, Tiril 5, Helene 4, Caroline 3, og Helenes bil står på Kruke hele dagen; førerkort som i src/lib/participants.ts (automat kan bare kjøre Carolines og Tirils bil; ingen uten oppgitt lapp kjører); 9-seteren med henger kjøres bare av noen med manuell lapp; hvert run må ha nok sjåfører til å få alle biler og kajakker dit de skal; ingen skal kjøre noe de har sagt de ikke vil kjøre; ingen rookie padler to runs uten å ha bedt om det. Går det ikke opp, gjør det som går opp og forklar resten i kommentaren, eller avvis.
